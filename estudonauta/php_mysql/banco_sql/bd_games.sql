...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/08/2023 às 15:20
...
('admin', 'Everton Klegin', '$2y$10$fRgT09Nm3KnCp.4ZLwlE..G7.83OZAeYmUa0c20lJKGyKptiNu7oW', 'admin'),
('bruna', 'Bruna Souza', '$2y$10$kHEyk6hOyXGQvYVUBjiDyuL5LIdmfNrV4JTHoGVajBxgSdWu4VcKq', 'admin'),
('pedro', 'Pedro Paulo', '$2y$10$82hr.rxA/GWP8fkJr10xFOx9fqclZe8xHhs4.wM7UxmidbqPANk5.', 'editor'),
('teste', 'João da Silva', '$2y$10$M3YXst.cZomWLHM8E0E4e.T1ShQyzB.fNoXR6PbaT/LQ4CBVT9V/K', 'editor');
